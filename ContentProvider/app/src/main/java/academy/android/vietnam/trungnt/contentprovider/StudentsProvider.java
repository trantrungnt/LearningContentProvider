...
/**
 * Created by TrungNT on 12/31/2015.
 */
...
public class StudentsProvider extends ContentProvider{
    ...
    static final String PROVIDER_NAME = "provider.College";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case STUDENTS:
                return "vnd.android.cursor.dir/vnd.trungnt.students";
            case STUDENTS_ID:
                return "vnd.android.cusor.item/vnd.trungnt.students";
            default:
